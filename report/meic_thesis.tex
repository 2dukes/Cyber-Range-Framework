...
\additionalfronttext{Master's Thesis}
...
\begin{Prolog}
  \clearpage\thispagestyle{empty}\setcounter{page}{0}\phantom{}\clearpage
  \include{chapters/abstract} % the abstract
  \blankpage
  \include{chapters/acknows}  % the acknowledgments
  \blankpage
  \include{quotes/quote}    % initial quotation if desired
  \blankpage
  %\cleardoublepage
